...
(function() {
  ...
  LolClient = (function(_super) {
    ...
    LolClient.prototype.getInProgressMatch = function(acctId, cb) {
      var GetInProgressMatch, cmd,
        _this = this;
      GetInProgressMatch = lolPackets.GetInProgressMatch;
      cmd = new RTMPCommand(0x11, null, null, null, [new GetInProgressMatch(this.options).generate(acctId)]);
      return this.rtmp.send(cmd, function(err, result) {
        var _ref, _ref1;
        if (err) {
          return cb(err);
